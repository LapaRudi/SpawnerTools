/*
 * Created by NoJokeFNA | Julian on 26.02.20, 20:39
 */

/*
 * Created by NoJokeFNA | Julian on 02.01.20, 16:28
 */
...
public class UUIDFetcher {
    ...
    public static UUID getUUIDAt( String name, long timestamp ) {
        ...
        try {
            ...
            Bukkit.getConsoleSender().sendMessage(ChatColor.RED + "UUID von '" + name + "' konnte nicht abgefragt werden.");
        }
